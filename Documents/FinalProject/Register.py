...
class Register:
    def __init__(self):
        ...
        name_input = tk.Entry(second_frame, font=("Arial", 10), width=30)
        name_input.grid(row=1, column=1, padx=10, pady=15)
        ...
        username_input = tk.Entry(second_frame, font=("Arial", 10), width=30)
        username_input.grid(row=2, column=1, padx=10, pady=17)

        email_label = tk.Label(second_frame, text="Email", font=("Sans", 10), bg='white')
        email_label.grid(row=3, column=0, padx=10, pady=17)

        email_input = tk.Entry(second_frame, font=("Arial", 10), width=30)
        email_input.grid(row=3, column=1, padx=10, pady=17)
        ...
        password_input = tk.Entry(second_frame, show="*", font=("Arial", 10), width=30)
        password_input.grid(row=4, column=1, padx=10, pady=15)
        ...
        confirm_password_input = tk.Entry(second_frame, show="*", font=("Arial", 10), width=30)
        confirm_password_input.grid(row=5, column=1, padx=10, pady=15)
